    ...
    <div className="page">
      ...
      <header className="panel hero" id="summary">
        ...
        <p className="lede alt">
          Welcome to my Mystery Dungeon — step into the hub to see featured builds, skills, and how we can team up for your next adventure!
        </p>
          ...
          {projects.map((project) => (
            <article className="project-card" key={project.title}>
              ...
              <div className="meta-row">
                ...
                <Link className="link details-btn" to={`/project/${project.id}`}>
